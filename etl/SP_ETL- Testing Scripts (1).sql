...
update CUSTOMER_SRC set FULLNAME='Kapil P' where CUSTOMERID=1

update CUSTOMER_SRC set BIRTHDATE='1996-09-15' where CUSTOMERID=2

update CUSTOMER_SRC set MARITALSTATUS='M' where CUSTOMERID=3

update CUSTOMER_SRC set GENDER='F' where CUSTOMERID=4
